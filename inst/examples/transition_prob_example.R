...
patient_sample <- sample(unique(cav_not_na$PTNUM), 10L)
...
transition_prob("well-mild", tval, vt, mlo$opt$par, gg)
transition_prob_ci_band("well-mild", tval, vt, mlo$opt$par, gg, hessian = mlo$hess)

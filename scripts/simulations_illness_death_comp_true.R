...
sum_all_comp = function(a, t_type0, t_type1, t_type2, t_type3, mc_cores){
  type_1_comp = -sum(unlist(mclapply(seq_len(nrow(t_type0)), function(i) (log(S_01_comp(a = a,  t = t_type0[i, 1], x = t_type0[i, 2])*
...
sum_all_embed = function(a, t_type0, t_type1, t_type2, t_type3, mc_cores){
  type_1_embed = -sum(unlist(mclapply(seq_len(nrow(t_type0)), function(i) (log(S_01_embed(a = a,  t = t_type0[i, 1], x = t_type0[i, 2])+
